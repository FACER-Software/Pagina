    ...
    <body>
        ...
        <div class="wrapperPerfil mb-4">
            <div class="container">
                <%
                    //Variables
                   String Nombre = request.getParameter("NobreCondu");
                   String Correo = request.getParameter("correoPoli");
                   String Contra = request.getParameter("pass");
                   String Cel = request.getParameter("celularCondu");
                   String Edad = request.getParameter("EdadCondu");
                   String Foto = request.getParameter("FotoCondu");
                   String FotoLic = request.getParameter("FotoLicencia");
                   String FotoINE = request.getParameter("FotoINE");
                   ...
                   String NomMunicipio = request.getParameter("Muni");
                    ...
                    try {
                           String querystring = "call spAltaCondu(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
                           ...
                           cs.setString(5, Edad);
                           cs.setString(6, Foto);
                           cs.setString(7, FotoLic);
                           cs.setString(8, FotoINE);
                           cs.setString(9, rutas);
